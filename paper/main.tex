...
particular, we have considered two instances of each class, focusing on relatively instances (the computation of CEGO grows rapidly with instance size):
\texttt{N-p40-01}, \texttt{N-p40-02}, \texttt{N-p50-01}, \texttt{N-p50-02} (RandB), 
lop/RandB/
lop/IO/N-t59d11xx
lop/IO/N-t59b11xx
lop/SGB/N-sgb75.02
...
: IO, Random instances of type A and
...
types.\MANUEL{Needs updating}

In the case of the PFSP, we consider the same instances as
\citet{ZaeStoBar2014:ppsn}, i.e., \texttt{reC05}, \texttt{reC13} and
\texttt{reC19} for the PFSP, with $n \in \{20, 20, 30\}$, respectively.
