...
\begin{tabular}{r@{\hskip -2ex}*{5}{r}rl*{3}{r}}
 \toprule
            &                  & \mcolc{4}{Mean fitness (sd)} & \mcolc{2}{\multirow[b]{2.45}{*}{\shortstack{95\% CI for the\\mean difference}}} & \bf \multirow[b]{2.45}{*}{\shortstack{Mean FE\\CEGO}} & \mcolc{2}{Mean runtime} \\\cmidrule(lr){3-6}\cmidrule(lr){10-11}
