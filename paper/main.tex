...
\ekhine{}{meter esto https://arxiv.org/pdf/1903.03332.pdf }
...
For the LOP, we generated synthetic instances as follows: sample 200 permutations from a MM of size $n=20$ and $\theta=\{-\log(.5), -\log(.7), -\log(.9)\}$, i.e., from peaked distributions to almost uniform distributions. Then, generate matrix $a$ as $a_{i,j} = \sum_{\sigma\in S}\sum_{i<j}\mathbb{I}(\sigma(i)<\sigma(j))$.
