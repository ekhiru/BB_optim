...
\begin{table*}[tb]%time
  \caption{Mean fitness (and standard deviation), over 10 independent runs for each problem instance, of the best solution found at the end of each run of the original CEGO (\CEGOorig) and its improved version (\CEGOinv) and three configurations of UMM that different in the budget of evaluations $m \in \{100, 200, 400\}$. The runs of CEGO used a budget of $m=400$.\label{tab:results_fitness}}
