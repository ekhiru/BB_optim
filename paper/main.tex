...
\begin{tabular}{*{6}{r}rl*{3}{r}}
 \toprule
           &                  & \mcolc{4}{Mean fitness (sd)} &  \mcolc{2}{\multirow[b]{2.45}{*}{\shortstack{95\% CI for the\\mean difference}}}         & \mcolc{2}{Mean runtime}             & \bf \multirow[b]{2.45}{*}{\shortstack{Mean FE\\CEGO}}\\\cmidrule{3-6}\cmidrule(lr){9-10}
\bf Problem & \bf     Instance & \mcolc{2}{UMM}               & \mcolc{2}{CEGO} & & & \bf UMM  & \bf CEGO                                  & \bf            \\\midrule
